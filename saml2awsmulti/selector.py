...
# To use custom styles, see https://inquirerpy.readthedocs.io/en/latest/pages/style.html?highlight=style#customising-style
...
def prompt_roles_selection(options, last_selected_options):
    ...
    choices = [
        Choice(role, enabled=role in last_selected_options)
        for role in options
    ]
