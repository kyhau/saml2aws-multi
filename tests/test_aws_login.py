...
class TestCreateProfileNameFromRoleArn:
    def test_role_name_format(self):
        ...
        result = create_profile_name_from_role_arn(role_arn, account_alias, "RoleName")
        assert result == "dev"
    ...
    def test_role_name_account_alias_format(self):
        ...
        result = create_profile_name_from_role_arn(role_arn, account_alias, "RoleName-AccountAlias")
...
class TestMainCli:
    ...
    @patch("saml2awsmulti.aws_login.pre_select_options")
    @patch("saml2awsmulti.aws_login.prompt_roles_selection")
    def test_main_cli_nothing_selected(
        self, mock_prompt, mock_pre_select, mock_create_dict, mock_helper_class, caplog
    ):
        runner = CliRunner()
        mock_helper = Mock()
        mock_helper_class.return_value = mock_helper
